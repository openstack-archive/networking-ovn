...
class OVNClientQosExtension(object):
    ...
    def get_ports_by_network_id(self, context, network_id):
        ...
        return query.filter(models_v2.Port.network_id == network_id).all()
    ...
    def update_network(self, txn, network, original_network, reset=False,
        ...
        admin_context = n_context.get_admin_context()
        for port in self.get_ports_by_network_id(admin_context, network['id']):
